...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private func buildWindow() {
        ...
        let subtitle = NSTextField(wrappingLabelWithString: "不用终端，不用输入命令。首次安装后，以后双击这个应用即可启动 QQ 皮肤版 Codex。")
        ...
        [icon, title, subtitle, statusLabel, primaryButton, actions].forEach(stack.addArrangedSubview)
